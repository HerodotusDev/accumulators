...
describe("core", () => {
  ...
  it("should generate mmr with genesis for keccak hasher", async () => {
    ...
    expect(await mmr.rootHash.get()).toEqual("0xffbb02de013f6837d8e0da5f4215c53634c32a4f5eb2520f26a1d6d2f615db72");
    ...
    expect(await mmr.rootHash.get()).toEqual("0xaeb642d0f47f806382c66494ccf42c7d37eb3e09ba507a3b842e2a080c745200");
    ...
    expect(await mmr.rootHash.get()).toEqual("0xdae951c569985cea6033958972846338710ba372aef365053428d1eccfe5e5ce");
    ...
    expect(await mmr.rootHash.get()).toEqual("0xd4675f556d04ea6828165e6ad778f3162978588890061692189a55002d93572a");
    ...
    expect(await mmr.rootHash.get()).toEqual("0x70c01463d822d2205868c5a46eefc55658828015b83e4553c8462d2c6711d0e0");
    ...
    expect(await mmr.rootHash.get()).toEqual("0x7d0011a4256839263340fb483eb9fe3f6ce8506c9cc39699d8c1a65d8f34257a");
    ...
    expect(await mmr.rootHash.get()).toEqual("0x961d2a731654c2d9027c787a9296c66f841d1ee4a13abfdf7a83b70fd7217060");
    ...
    expect(await mmr.rootHash.get()).toEqual("0x4226038dc6fba77fa92ce5d63a49945266065914571c59ef85bdf184eee6dc36");
    ...
    expect(await mmr.rootHash.get()).toEqual("0xc5cce3ec5640e0165df5cf8aa5897eb7b9b54b6c4a17d13e0a007b12cfc223cd");
    ...
    expect(await mmr.rootHash.get()).toEqual("0x4654b1a9b7311b0b896ada391a9481db2c0756d9c0f32658facff9eec32cd18b");
  ...
  it("should generate mmr with genesis for poseidon hasher", async () => {
    ...
    expect(await mmr.leavesCount.get()).toEqual(2);
    expect(await mmr.elementsCount.get()).toEqual(3);
    expect(await mmr.rootHash.get()).toEqual("0x1070995027591e1b97c73c0e59933ee1a4227781434dd94b2d4dc87fd94cf92");
    
     // block 9734439
    await mmr.append("0x312134454804550b4a38e1d60dc1f0be80ff62dfea8f3c6be0c257efce3b833");
    expect(await mmr.leavesCount.get()).toEqual(3);
    expect(await mmr.elementsCount.get()).toEqual(4);
    expect(await mmr.rootHash.get()).toEqual("0x1a2be63d0560708d3eb87319be0442016ba8757557da8009096e95c4b0682d9");
      
    // block 9734440
    await mmr.append("0x6f0b4ef760469262221de032372c2a6b47b304a48b632af80611fc2e2e10b56");
    expect(await mmr.leavesCount.get()).toEqual(4);
    expect(await mmr.elementsCount.get()).toEqual(7);
    expect(await mmr.rootHash.get()).toEqual("0x1006c333b41230ee484977b481e0e4e530f454a6d14902ce593ed2dbf649a25");

    // block 9734441
    await mmr.append("0x7f6d47c24e8723a6d6cf4ef089df0bd3ec710d5448b696e47b037109a1d04ce");
    expect(await mmr.leavesCount.get()).toEqual(5);
    expect(await mmr.elementsCount.get()).toEqual(8);
    expect(await mmr.rootHash.get()).toEqual("0x4f05ebf1a932fdc481d43eb577ad326e5a8c743fbc8624eb98010b65f8c5b89");

    // block 9734442
    await mmr.append("0x38e557fbc306cbcb5964a503014b375db68a0c6786fd9c6ffc5cdd14b6c9dfc");
    expect(await mmr.leavesCount.get()).toEqual(6);
    expect(await mmr.elementsCount.get()).toEqual(10);
    expect(await mmr.rootHash.get()).toEqual("0x13bdeaf86b66a03cb316c62d475a7e8d037d30ee7b5d52ff1b13f2fb951b527");

    // block 9734443
    await mmr.append("0x54aa6067e8c4f6bcd7c47cf7900df1d960098177e186f0c15b6a7544491b539");
    expect(await mmr.leavesCount.get()).toEqual(7);
    expect(await mmr.elementsCount.get()).toEqual(11);
    expect(await mmr.rootHash.get()).toEqual("0x763a6f33c8cf7b1411cf23910ddba74841dc4b52c73ecfb57ddc40160c78fc6");

    // block 9734444
    await mmr.append("0x2f185aa16419cad043ddb0b75a7ba0c4233d51b7fee31f1ad6680f5c2b53677");
    expect(await mmr.leavesCount.get()).toEqual(8);
    expect(await mmr.elementsCount.get()).toEqual(15);
    expect(await mmr.rootHash.get()).toEqual("0x7abaf3802dee5c46f80d30101a3882645070d0968758b2a9b7a3bc5e1a059fa");

    // block 9734445
    await mmr.append("0x3ff20a1d65c24d07ebedb2de39c0a27e67808b49d1544e8ef972da1d24da302");
    expect(await mmr.leavesCount.get()).toEqual(9);
    expect(await mmr.elementsCount.get()).toEqual(16);
    expect(await mmr.rootHash.get()).toEqual("0x27f8b7a2ed6d1290833c6fa587d564a8810ee1925b1b2cdfde8da1cefdee57b");

     // block 9734446
    await mmr.append("0x437048beb7e0b3f95fb670e34ac4bd2f32acf6a8ad3eb5fc08682f285ad805b");
    expect(await mmr.leavesCount.get()).toEqual(10);
    expect(await mmr.elementsCount.get()).toEqual(18);
    expect(await mmr.rootHash.get()).toEqual("0x2c02006787d05a482e0a19771a82c353d65a8eff7e69e1be9ae2219d0400951");

     // block 9734447
    await mmr.append("0x3cd2cd10c8fedcccab3691f9852b25936ef838e0c826e39ecba3354f23664cd");
    expect(await mmr.leavesCount.get()).toEqual(11);
    expect(await mmr.elementsCount.get()).toEqual(19);
    expect(await mmr.rootHash.get()).toEqual("0x2ca29d4ac90ce8715232f2af120c77a4d647771d76e0720afc1fd330aa64577");
